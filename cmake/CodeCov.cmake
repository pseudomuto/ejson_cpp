...
add_custom_target(codecov
        ...
        COMMAND ${GCOVR_PATH} --exclude-throw-branches -r .. --object-directory "${PROJECT_BINARY_DIR}" -e ".*/\.conan/.*" -e ".*/tests/.*" -e ".*/usr/.*" --print-summary
        COMMAND ${GCOVR_PATH} --xml --exclude-throw-branches -r .. --object-directory "${PROJECT_BINARY_DIR}" -e ".*/\.conan/.*" -e ".*/tests/.*" -e ".*/usr/.*" -o codecov.xml)
